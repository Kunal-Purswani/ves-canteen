...
const ordItems = document.querySelector('#ord-items')
            ...
            for (users in data) {
                ...
                for (order in data[users]) {
                    ...
                    if (order == id) {
                        ...
                        if (data[users][order].hasOwnProperty('Lab_No')){
                            tp= '<div class="lab flex-1"><label for="lab-no">Lab No.</label><h4 class="flex1" id="lab-no">&nbsp; &nbsp;' + data[users][order].Lab_No + '</h4></div>'
                            headDiv.innerHTML+=tp
                        }
